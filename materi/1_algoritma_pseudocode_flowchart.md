...
<img src="../.gitbook/assets/alur_program.png" alt="Alur Program" width="300">
...
Algoritma menghasilkan output yang sesuai dengan tujuan yang ingin dicapai. Hasil yang diharapkan. `luas`

### Contoh Analisis Masalah

> Sistem ingin menghitung total pembayaran sebuah barang.

Diketahui: `harga barang, jumlah barang`
...
<img src="../.gitbook/assets/flowchart_symbol.png" alt="Alur Program (source: tutorialspoint.com)" width="600">
